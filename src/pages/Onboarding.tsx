...
const Onboarding = () => {
  ...
  const steps = [
    ...
    <div key="welcome" className="flex flex-col items-center justify-center min-h-screen px-6 animate-fade-in">
      ...
      <h1 className="text-3xl font-bold mb-3">مرحباً بك في صحتي</h1>
      <p className="text-muted-foreground text-center text-lg mb-10 leading-relaxed">
        تطبيقك الشخصي لإدارة صحتك ومتابعة أدويتك وتحاليلك
      </p>
    ...
    <div key="basic" className="px-6 pt-12 animate-fade-in">
      ...
      <p className="text-muted-foreground mb-6">أخبرنا عنك</p>
    ...
    <div key="medical" className="px-6 pt-12 animate-fade-in">
      ...
      <h2 className="text-2xl font-bold mb-1">المعلومات الطبية</h2>
      <p className="text-muted-foreground mb-6">حالتك الصحية</p>
      <div className="space-y-4">
        <div>
        ...
        <div>
          ...
          <input value={form.doctorName} onChange={e => setForm(p => ({ ...p, doctorName: e.target.value }))}
            className="w-full bg-secondary rounded-xl px-4 py-3 text-foreground outline-none focus:ring-2 focus:ring-primary touch-target" placeholder="د. أحمد" />
        </div>
        <div>
          ...
          <input type="tel" value={form.emergencyNumber} onChange={e => setForm(p => ({ ...p, emergencyNumber: e.target.value }))}
            className="w-full bg-secondary rounded-xl px-4 py-3 text-foreground outline-none focus:ring-2 focus:ring-primary touch-target" placeholder="05xxxxxxxx" />
        </div>
      </div>
